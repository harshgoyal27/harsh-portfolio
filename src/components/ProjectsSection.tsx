...
const PROJECTS: ProjectData[] = [
    {
        number: '01',
        category: 'Personal',
        name: 'Human Detection with openCV',
        liveUrl: 'https://github.com/itachi766/Human-detection-openCV.git',
        col1Image1: '/open.png',
        col1Image2: '/open2.png',
        col2Image: '/open3.png',
      },
  {
      number: '02',
      category: 'Personal',
      name: 'Password Door Lock',
      liveUrl: 'https://github.com/itachi766/Password-Door-Lock.git',
      col1Image1: '/door.png',
      col1Image2: '/door2.png',
      col2Image: '/door3.png',
    },
];
